            ...
            <form onSubmit={handleRegister} className="flex flex-col gap-5">
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="h-12 w-full rounded-lg border border-[#E5E7EB] bg-white pl-4 pr-4 text-sm text-black outline-none transition placeholder:text-[#73839A] focus:border-[#3567F4] focus:ring-2 focus:ring-[#3567F4]/10"
                />
              </div>
              <div className="flex flex-col gap-2">
                <label
